...
const { firstName, lastName, homeCountry, fullName, isJorge, mySentence, randomNumber, theAnswer, funkyInitials, x, y, var1, var2, var3, var4q, var4a } = require('./index.js')
let q2answer
let q3answer
let q4answer
let q5answer
...
describe("Testing var4q and var4a vars", () => {
...
q4answer = (firstName.charAt(firstName.length - 1) + lastName.charAt(lastName.length - 1)).toUpperCase()
q5answer
  if (firstName == "Jorge") {
    q5answer = true
  } else {
